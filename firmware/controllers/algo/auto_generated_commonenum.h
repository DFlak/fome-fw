...
constexpr inline const char* getGearControllerMode(GearControllerMode value) {
	switch (value) {
...
constexpr inline const char* getInjectionTimingMode(InjectionTimingMode value) {
	switch (value) {
...
constexpr inline const char* getInjectorNonlinearMode(InjectorNonlinearMode value) {
	switch (value) {
		case INJ_FordModel:
...
constexpr inline const char* getSelectedGear(SelectedGear value) {
	switch (value) {
...
constexpr inline const char* getTransmissionControllerMode(TransmissionControllerMode value) {
	switch (value) {
...
constexpr inline const char* getTsCalMode(TsCalMode value) {
	switch (value) {
...
constexpr inline const char* getWssToVssMode(WssToVssMode value) {
	switch (value) {
...
constexpr inline const char* getAir_pressure_sensor_type_e(air_pressure_sensor_type_e value) {
	switch (value) {
		case MT_BOSCH_2_5:
			return "MT_BOSCH_2_5";
		case MT_CUSTOM:
...
constexpr inline const char* getAntiLagActivationMode_e(antiLagActivationMode_e value) {
	switch (value) {
...
constexpr inline const char* getBoostType_e(boostType_e value) {
	switch (value) {
		case CLOSED_LOOP:
			return "CLOSED_LOOP";
		case OPEN_LOOP:
...
constexpr inline const char* getBrain_pin_diag_e(brain_pin_diag_e value) {
	switch (value) {
		case PIN_DRIVER_OFF:
...
constexpr inline const char* getCan_nbc_e(can_nbc_e value) {
	switch (value) {
		case CAN_AIM_DASH:
			return "CAN_AIM_DASH";
...
constexpr inline const char* getCan_vss_nbc_e(can_vss_nbc_e value) {
	switch (value) {
		case BMW_e46:
			return "BMW_e46";
		case BMW_e90:
...
constexpr inline const char* getDc_function_e(dc_function_e value) {
	switch (value) {
		case DC_None:
			return "DC_None";
		case DC_Throttle1:
...
constexpr inline const char* getEgo_sensor_e(ego_sensor_e value) {
	switch (value) {
...
constexpr inline const char* getEngine_load_mode_e(engine_load_mode_e value) {
	switch (value) {
		case LM_ALPHA_N:
			return "LM_ALPHA_N";
		case LM_LUA:
...
constexpr inline const char* getFuel_pressure_sensor_mode_e(fuel_pressure_sensor_mode_e value) {
	switch (value) {
		case FPM_Absolute:
			return "FPM_Absolute";
...
constexpr inline const char* getGear_e(gear_e value) {
	switch (value) {
		case GEAR_1:
			return "GEAR_1";
		case GEAR_2:
...
constexpr inline const char* getGppwm_compare_mode_e(gppwm_compare_mode_e value) {
	switch (value) {
...
constexpr inline const char* getHpfp_cam_e(hpfp_cam_e value) {
	switch (value) {
		case HPFP_CAM_EX1:
			return "HPFP_CAM_EX1";
		case HPFP_CAM_EX2:
...
constexpr inline const char* getIdle_mode_e(idle_mode_e value) {
	switch (value) {
		case IM_AUTO:
			return "IM_AUTO";
		case IM_MANUAL:
...
constexpr inline const char* getIgnition_mode_e(ignition_mode_e value) {
	switch (value) {
...
constexpr inline const char* getImu_type_e(imu_type_e value) {
	switch (value) {
		case IMU_MM5_10:
			return "IMU_MM5_10";
		case IMU_NONE:
...
constexpr inline const char* getInjection_mode_e(injection_mode_e value) {
	switch (value) {
		case IM_BATCH:
			return "IM_BATCH";
		case IM_SEQUENTIAL:
...
constexpr inline const char* getInjector_compensation_mode_e(injector_compensation_mode_e value) {
	switch (value) {
...
constexpr inline const char* getInjector_pressure_type_e(injector_pressure_type_e value) {
	switch (value) {
		case IPT_High:
			return "IPT_High";
		case IPT_Low:
...
constexpr inline const char* getLaunchActivationMode_e(launchActivationMode_e value) {
	switch (value) {
...
constexpr inline const char* getLoad_override_e(load_override_e value) {
	switch (value) {
		case AFR_AccPedal:
			return "AFR_AccPedal";
		case AFR_CylFilling:
...
constexpr inline const char* getOperation_mode_e(operation_mode_e value) {
	switch (value) {
...
constexpr inline const char* getPin_input_mode_e(pin_input_mode_e value) {
	switch (value) {
		case PI_DEFAULT:
			return "PI_DEFAULT";
		case PI_PULLDOWN:
...
constexpr inline const char* getPin_output_mode_e(pin_output_mode_e value) {
	switch (value) {
		case OM_DEFAULT:
			return "OM_DEFAULT";
		case OM_INVERTED:
...
constexpr inline const char* getSpi_device_e(spi_device_e value) {
	switch (value) {
		case SPI_DEVICE_1:
			return "SPI_DEVICE_1";
		case SPI_DEVICE_2:
...
constexpr inline const char* getSpi_speed_e(spi_speed_e value) {
	switch (value) {
		case _150KHz:
			return "_150KHz";
		case _1_25MHz:
...
constexpr inline const char* getStepper_num_micro_steps_e(stepper_num_micro_steps_e value) {
	switch (value) {
		case STEPPER_EIGHTH:
...
constexpr inline const char* getTChargeMode_e(tChargeMode_e value) {
	switch (value) {
...
constexpr inline const char* getTiming_mode_e(timing_mode_e value) {
	switch (value) {
		case TM_DYNAMIC:
			return "TM_DYNAMIC";
		case TM_FIXED:
...
constexpr inline const char* getTle8888_mode_e(tle8888_mode_e value) {
	switch (value) {
		case TL_AUTO:
			return "TL_AUTO";
		case TL_HALL:
...
constexpr inline const char* getVvt_mode_e(vvt_mode_e value) {
	switch (value) {
